...
class SubscribersCreator:
    def __init__(self, subs_repo: SubscribersRepositoryInterface) -> None:
    ...
    def __check_sub(self, subscriber_email: str, subscriber_evento_id: int) -> None:
        response = self.__subs_repo.select_subscriber(subscriber_email, subscriber_evento_id)
